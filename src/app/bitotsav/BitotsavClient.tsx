...
export default function BitotsavClient({ initialClaps }: { initialClaps: number }) {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-white selection:text-black overflow-hidden font-sans">
            ...
            <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-white/2 blur-[120px] pointer-events-none" />
            ...
            <div className="max-w-3xl mx-auto px-6 pt-32 pb-24 relative z-10">
                <div className="flex flex-col items-center text-center space-y-24">
                    ...
                    >
                        <div className="bg-white/3 border border-white/10 rounded-3xl p-10 backdrop-blur-sm hover:border-white/20 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full">
                        <a 
                            ...
                            className="flex items-center justify-center gap-3 bg-white/3 border border-white/10 py-5 rounded-2xl hover:bg-white/6 transition-all group"
                        >
